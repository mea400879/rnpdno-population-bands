...
\begin{table}[htbp]
  \centering
  \caption{LISA cluster classification counts by outcome status, \referencemonth{}
...
\begin{table}[htbp]
  ...
  \caption{Pairwise overlap of High-High municipalities across outcome statuses,
           \referencemonth{} (diagonal = total HH count per status; off-diagonal = Jaccard similarity).}
  \label{tab:crosstab}
