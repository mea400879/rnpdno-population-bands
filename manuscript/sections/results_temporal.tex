...
\begin{table}[htbp]
  \centering
  \caption{OLS trend slopes in HH cluster municipalities (municipalities per year) by region and outcome status, \studyperiod{}.
           Standard errors: Newey-West HAC (bandwidth = 12).
